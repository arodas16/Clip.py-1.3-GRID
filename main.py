...
how_to_entry = Entry(toolbar, width=20)
how_to_entry.pack(side=LEFT, padx=1, pady=1)

hca_label = Label(toolbar, text="HC: ")
hca_label.pack(side=LEFT, padx=1, pady=1)

hca_entry = Entry(toolbar, width=10)
hca_entry.pack(side=LEFT, padx=1, pady=1)


submit_butt = Button(toolbar, text="Submit", command=submit_how_to)
submit_butt.pack(side=LEFT, padx=15, pady=1)

clear_butt = Button(toolbar, text="Clear", command=clear_how_to)
clear_butt.pack(side=LEFT, padx=5, pady=1)

copy_notes_butt = Button(toolbar, text="Copy notes", command=notes_clip)
copy_notes_butt.pack(side=RIGHT, padx=5, pady=1)

copy_email_butt = Button(toolbar, text="Copy email", command=email_clip)
copy_email_butt.pack(side=RIGHT, padx=5, pady=1)
